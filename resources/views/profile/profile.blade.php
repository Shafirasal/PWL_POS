        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('/profile/profileEdit/store') }}" method="POST"> <!-- Ensure the URL is correct -->
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="old_password">Password Lama</label>
                            <input type="password" name="old_password" id="old_password" class="form-control" required_with="new_password">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="confirm_password">Konfirmasi Password Baru</label>
                            <input type="password" name="confirm_password" id="confirm_password" class="form-control" placeholder="Kosongkan jika tidak ingin mengubah password">
                        </div>
